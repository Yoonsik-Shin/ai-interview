...
export interface InterviewServiceGrpcController {
    ...
    getInterviewStage(
        ...
        | Promise<GetInterviewStageResponse>
        | Observable<GetInterviewStageResponse>
        | GetInterviewStageResponse;

    transitionStage(
        request: TransitionStageRequest,
        metadata?: Metadata,
    ):
        | Promise<TransitionStageResponse>
        | Observable<TransitionStageResponse>
...
export function InterviewServiceGrpcControllerMethods() {
    return function (constructor: Function) {
        ...
        for (const method of grpcMethods) {
            ...
            GrpcMethod("InterviewServiceGrpc", method)(
        ...
        for (const method of grpcStreamMethods) {
            const descriptor: any = Reflect.getOwnPropertyDescriptor(constructor.prototype, method);
            GrpcStreamMethod("InterviewServiceGrpc", method)(
                constructor.prototype[method],
                method,
                descriptor,
            );

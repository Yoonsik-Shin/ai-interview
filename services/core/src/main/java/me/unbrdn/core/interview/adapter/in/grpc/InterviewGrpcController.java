...
public class InterviewGrpcController extends InterviewServiceGrpcGrpc.InterviewServiceGrpcImplBase {
    ...
    @Override
    public void incrementSelfIntroRetry(me.unbrdn.core.grpc.InterviewProto.IncrementSelfIntroRetryRequest request,
            StreamObserver<me.unbrdn.core.grpc.InterviewProto.IncrementSelfIntroRetryResponse> responseObserver) {
        ...
        try {
            ...
            me.unbrdn.core.grpc.InterviewProto.IncrementSelfIntroRetryResponse response = me.unbrdn.core.grpc.InterviewProto.IncrementSelfIntroRetryResponse
    ...
    @Override
    public void listInterviews(me.unbrdn.core.grpc.InterviewProto.ListInterviewsRequest request,
            StreamObserver<me.unbrdn.core.grpc.InterviewProto.ListInterviewsResponse> responseObserver) {
        ...
        try {
            ...
            me.unbrdn.core.grpc.InterviewProto.ListInterviewsResponse.Builder responseBuilder = me.unbrdn.core.grpc.InterviewProto.ListInterviewsResponse
                    .newBuilder();
    ...
    private me.unbrdn.core.grpc.InterviewProto.InterviewSessionSummary toProtoInterviewSummary(
            me.unbrdn.core.interview.application.port.in.ListInterviewsUseCase.InterviewSummary summary) {
        return me.unbrdn.core.grpc.InterviewProto.InterviewSessionSummary.newBuilder()
    ...
    private static me.unbrdn.core.grpc.InterviewProto.InterviewTypeProto toProtoInterviewType(
            me.unbrdn.core.interview.domain.enums.InterviewType type) {
        return switch (type) {
        case REAL -> me.unbrdn.core.grpc.InterviewProto.InterviewTypeProto.REAL;
        case PRACTICE -> me.unbrdn.core.grpc.InterviewProto.InterviewTypeProto.PRACTICE;
        };
    }
    ...
    private static me.unbrdn.core.grpc.InterviewProto.InterviewStageProto toProtoInterviewStage(
        ...
        case LAST_QUESTION_PROMPT -> me.unbrdn.core.grpc.InterviewProto.InterviewStageProto.LAST_QUESTION_PROMPT;
        case LAST_ANSWER -> me.unbrdn.core.grpc.InterviewProto.InterviewStageProto.LAST_ANSWER;
        case CLOSING_GREETING -> me.unbrdn.core.grpc.InterviewProto.InterviewStageProto.CLOSING_GREETING;
    ...
    private static me.unbrdn.core.grpc.InterviewProto.InterviewPersonalityProto toProtoInterviewPersonality(
            me.unbrdn.core.interview.domain.enums.InterviewPersonality personality) {
        if (personality == null)
            return me.unbrdn.core.grpc.InterviewProto.InterviewPersonalityProto.INTERVIEW_PERSONALITY_UNSPECIFIED;
        return switch (personality) {
        case PRESSURE -> me.unbrdn.core.grpc.InterviewProto.InterviewPersonalityProto.PRESSURE;
        case COMFORTABLE -> me.unbrdn.core.grpc.InterviewProto.InterviewPersonalityProto.COMFORTABLE;

    ...
    public void createInterview(
        ...
        CreateInterviewCommand command =
                CreateInterviewCommand.builder()
                        ...
                        .roles(request.getInterviewerRolesList().stream().map(Enum::name).toList())
                        .personality(request.getPersonality().name())
    ...
    public void getInterviewStage(
        ...
        if (result.roles() != null) {
            responseBuilder.addAllInterviewerRoles(
                    result.roles().stream().map(mapper::toProtoInterviewRole).toList());
        }
        if (result.personality() != null) {
            responseBuilder.setPersonality(
                    mapper.toProtoInterviewPersonality(result.personality()));
        }

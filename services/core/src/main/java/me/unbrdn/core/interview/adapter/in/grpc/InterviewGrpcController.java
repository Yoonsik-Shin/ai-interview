...
public class InterviewGrpcController extends InterviewServiceGrpcGrpc.InterviewServiceGrpcImplBase {
    ...
    private final me.unbrdn.core.interview.application.port.in.ListInterviewsUseCase
    ...
    public void listInterviews(
            me.unbrdn.core.grpc.InterviewProto.ListInterviewsRequest request,
            StreamObserver<me.unbrdn.core.grpc.InterviewProto.ListInterviewsResponse>
                    responseObserver) {
        ...
        try {
            ...
            me.unbrdn.core.grpc.InterviewProto.ListInterviewsResponse.Builder responseBuilder =
                    me.unbrdn.core.grpc.InterviewProto.ListInterviewsResponse.newBuilder();

            responseBuilder.addAllInterviews(
                    summaries.stream().map(this::toProtoInterviewSummary).toList());
            ...
            responseObserver.onError(
                    io.grpc.Status.INTERNAL
                            .withDescription("Failed to list interviews: " + e.getMessage())
                            .asRuntimeException());
        }
    }

    private me.unbrdn.core.grpc.InterviewProto.InterviewSessionSummary toProtoInterviewSummary(
            me.unbrdn.core.interview.application.port.in.ListInterviewsUseCase.InterviewSummary
                    summary) {

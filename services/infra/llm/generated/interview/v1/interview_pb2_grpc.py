...
class InterviewServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TransitionStage = channel.unary_unary(
                ...
                _registered_method=True)
        self.RetrySelfIntro = channel.unary_unary(
                '/interview.v1.InterviewService/RetrySelfIntro',
                request_serializer=interview_dot_v1_dot_interview__pb2.RetrySelfIntroRequest.SerializeToString,
                response_deserializer=interview_dot_v1_dot_interview__pb2.RetrySelfIntroResponse.FromString,
                _registered_method=True)
...
class InterviewServiceServicer(object):
    ...
    def RetrySelfIntro(self, request, context):
        """자기소개 리트라이 제어 (STT 우회)
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
...
def add_InterviewServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'RetrySelfIntro': grpc.unary_unary_rpc_method_handler(
                    servicer.RetrySelfIntro,
                    request_deserializer=interview_dot_v1_dot_interview__pb2.RetrySelfIntroRequest.FromString,
                    response_serializer=interview_dot_v1_dot_interview__pb2.RetrySelfIntroResponse.SerializeToString,
            ),
...
class InterviewService(object):
    ...
    def RetrySelfIntro(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/interview.v1.InterviewService/RetrySelfIntro',
            interview_dot_v1_dot_interview__pb2.RetrySelfIntroRequest.SerializeToString,
            interview_dot_v1_dot_interview__pb2.RetrySelfIntroResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,

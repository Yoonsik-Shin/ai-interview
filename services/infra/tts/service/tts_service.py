...
async def run_consumer(redis_client, stop_event: asyncio.Event) -> None:
    ...
    try:
        await redis_client.xgroup_create(TTS_SENTENCE_STREAM, TTS_CONSUMER_GROUP, id='0', mkstream=True)
    except Exception:
        ...
        try:
            ...
            for stream_key, messages in results:
                for message_id, message in messages:
                    ...
                    await redis_client.xack(TTS_SENTENCE_STREAM, TTS_CONSUMER_GROUP, message_id)

...
public class Subscription extends BaseTimeEntity {
    ...
    private Subscription(java.util.UUID userId, Plan plan, LocalDateTime startDate) {
        this.userId = userId;
        this.plan = plan;
    ...
    /** 새로운 구독 생성 */
    public static Subscription create(java.util.UUID userId, Plan plan, LocalDateTime startDate) {
        return new Subscription(userId, plan, startDate);
    }

...
public class Wallet extends BaseEntity {
    ...
    private Wallet(java.util.UUID userId, Integer freeCredits, Integer paidCredits) {
        this.userId = userId;
    ...
    public static Wallet create(java.util.UUID userId) {
        return new Wallet(userId, 2000, 0);
    }
